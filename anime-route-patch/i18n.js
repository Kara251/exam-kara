(function () {
  ...
  var UI = {
    ...
    hx: {
      ...
      pageDescription: "15道 ACG 題幫伱揪出這波最對味の本命番ヽ(✿ﾟ▽ﾟ)ノ",
      ogTitle: "2026 夏番伱這波該補哪部？",
      ogDescription: "15道題，幫伱鎖定這波最容易上頭の本命番",
      h1a: "夏番",
      h1b: "伱這波該補哪部？",
      sub: "15道題揪出伱這波の本命番，卟用多想直接測",
      go: "開測惹 ▶",
      rl: "伱 の 本 命 番 4",
      altT: "這波同樣讓伱超上頭の",
      avT: "這波大概卟太4伱の菜",
      ...
      resultVol: "VOL.2026",
      coverPlaceholder: "COVER ART",
      resultFooterSecondary: "夏番本命診斷",
      goodFallback: "整體調性跟伱這波の偏好幾乎完全對上惹(｡◕ᴗ◕｡)",
      avoidFallback: "整體調性跟伱這波の偏好有丶錯頻，這波可能卟4最對味の。",
      goodPrefix: "更貼近伱這波對",
      goodSuffix: "の偏好。",
      avoidPrefix: "它更偏向",
      avoidSuffix: "，這波可能卟最戳伱。",
      leadPrefix: "這波加權最高の理由，4伱明顯更吃",
      leadSuffix: "。",
      shareSaving: "存圖中…",
      shareFailed: "截圖存失敗惹，直接手機截圖叭(´；ω；`)",
