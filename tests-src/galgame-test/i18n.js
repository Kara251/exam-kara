(function () {
  ...
  var UI = {
    tc: {
      ...
      pageDescription: "從更大的題池隨機抽出 15 題，把路線口味、節奏偏好與內容承受度對成更適合你的 GalGame。",
      ogTitle: "GalGame 命定路線測驗",
      ogDescription: "43 部作品結果池，隨機抽題，幫你找出這輪更該先補的一部。",
      ...
      homeTitleA: "GalGame",
      homeTitleB: "命定路線",
      homeSubtitle: "15 道題，從更大的題池隨機抽題，把路線口味、節奏偏好與內容承受度對成更適合你的命定作品。",
      featureTag: "-- 路線導覽 --",
      spotlightLabel: "當前聚焦",
    ...
    en: {
      ...
      pageDescription: "A 15-question draw from a larger pool, matching route taste, pacing, and tolerance to a better-fit visual novel.",
      ogTitle: "GalGame route test",
      ogDescription: "A 43-title result pool with random question draws and a sharper route match.",
      gateKicker: "LANGUAGE INDEX",
      ...
      homeSubtitle: "15 questions are drawn from a larger pool to line up your route taste, pacing, and content tolerance with a sharper match.",
    ...
    ja: {
      ...
      pageDescription: "より大きい設問プールから15問を引き、ルートの好み、テンポ、内容耐性を今の自分に合う一本へつなぎます。",
      ogTitle: "GalGame 命定ルート診断",
      ogDescription: "43作品プールとランダム出題で、今の気分に合う一本を引き当てる診断ページ。",
      gateKicker: "LANGUAGE INDEX",
      ...
      homeTitleA: "GalGame",
      homeTitleB: "命定ルート",
      homeSubtitle: "より大きい設問プールから15問を引き、ルートの好み、読むテンポ、内容耐性を今の自分に合う一本へつなぎます。",
      featureTag: "-- ルート案内 --",
