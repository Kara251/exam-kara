...
var SITE_COPY = {
  ...
  hx: {
    ...
    heroMixedLine: "✧ EXAM KARA × 測驗索引 ✧",
    heroCopyTag: "-- 測驗合集 --",
    heroCopy: "先從夏番診斷開坑——凡4那種做著做著就有丶發癲、還會讓人上頭の互動企劃，統統收編在這裡。",
    ...
    heroMetaRoute: "CURRENT SEASON: SUMMER 2026",
    heroFooterPrimary: "INTERACTIVE TEST INDEX",
    heroFooterSecondary: "互動開坑總部",
    heroSparkle: "☆ﾟ.*･｡ﾟ",
    sectionKicker: "TEST INDEX",
    sectionTitle: "而家能玩同準備開坑の頁面",
    sectionNote: "每個試題都有自己の畫風同電波，卟過整體還4同一條編集腔調。",
    routeLabel: "ROUTE",
    sourceLabel: "SEASON",
    openTest: "進去開測",
    comingSoon: "蹲個開坑",
    ...
    tests: {
      ...
      next: {
        title: "下壹個試題坑",
        description: "下壹個測驗還在腦內施工——啥主題最讓伱想立刻點進來？",
        note: "歡迎丟提案，告訴莪伱下壹個最想測啥。"
      }
    }
  },
  wy: {
